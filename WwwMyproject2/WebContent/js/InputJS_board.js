...
//====이미지 파일 미리보기
    ...
    reader.onload = (function(theFile) {
      return function(e) {
        //이미지 뷰
        var img_view = ['<img src="', e.target.result, '" name="', escape(theFile.name), '"  width=400 height=200/>'].join('');                
...
function userWriterCheck(){
		
		var sabun = iform.sabun.value;
		var name = iform.name.value;
		var seasons=iform.seasons.value;
		var content = iform.content.value;
		var pay=iform.pay.value;
