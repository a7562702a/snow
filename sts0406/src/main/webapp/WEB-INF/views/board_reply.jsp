...
<form  method="get"  action="boardreply_insert.do" >
  <table width="700"  border='0' cellspacing="0" align="center">
 	<tr><td> &nbsp;idx값: <input type="text"  name="hobby_idx"  value="${dto.hobby_idx}" readonly></td></tr>
 	<tr>
 	  <td><b>작성자: </b>
 ...
 <p>
  <table width="750"  border='0' cellspacing="0" align="center">
   <tr  bgcolor="green"  height='30'  align="center">
 	   <td colspan=5><font color=white>==댓글 데이타 내용 표시==</font></td>       
   </tr>
