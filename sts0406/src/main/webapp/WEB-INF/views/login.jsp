 ...
 <table  width=750 border=1 cellspacing=0 align="center">
   <form action="loginprocess.do">
     <tr>
	  ...
	  <td width="250"> <input type="text"  name="userid"  value=""  placeholder="userid"></td>
	...
	<tr>
	  ...
	  <td> <input type="text"  name="pwd" value=""  placeholder="password"></td>
	</tr>
    </form>
 </table>
